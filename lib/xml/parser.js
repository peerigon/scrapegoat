                    ...
                    if (!expand.complete) {
                        ...
                        if (modifiedOccurences.length === 0) {
                            ...
                            if (isModified(nextOccuranceTime, modifiedOccurences)) {
                                ...
                                eventData = {
                                    title: vevents[key].getFirstPropertyValue("summary"),
                                    uid: vevents[key].getFirstPropertyValue("uid"),
                                    location: vevents[key].getFirstPropertyValue("location"),
                                    description: vevents[key].getFirstPropertyValue("description"),
                                    start: new Date(dtstart),
                                    end: new Date(dtend),
                                    duration: dtend.subtractDate(dtstart),
                                    type: { recurring: true, edited: true },
                                    createdAt: new Date(vevents[key].getFirstPropertyValue("created"))
                                };
