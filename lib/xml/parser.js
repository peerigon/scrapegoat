...
function parseEvents(xml, startDate = null, endDate = null) {
    let parsed;
    const formatted = [];
    ...
    return parseXMLString(xml, PARSE_XML_CONFIG).then((result) => {
        ...
        parsed.forEach((event) => {
            ...
            if (icalEvent.isRecurring()) {
                ...
                // Expand upto a maximum of 10 upcoming occurrences for events that never end
                const MAX_INFINITE_OCCURRENCES_COUNT = 10;
